CREATE TABLE panoramas(id serial, the_geom geometry, ele FLOAT, pan FLOAT DEFAULT 0, tilt FLOAT DEFAULT 0, roll FLOAT DEFAULT 0 authorised INT DEFAULT 0, userid INT DEFAULT 0, timestamp INT);
